- [Token](#token)
  ...
  - [如何使用token](#如何使用token)
    ...
    - [*实际用途*](#实际用途)
  - [交易对手风险](#交易对手风险)
  - [使用Tokens：效用或权益](#使用tokens效用或权益)
  - [Token标准](#token标准)
    - [ERC20 Token 标准](#erc20-token-标准)
    - [ERC223 - 一种建议的Token合同接口标准](#erc223---一种建议的token合同接口标准)
    - [ERC777 - 一种建议的Token合同接口标准](#erc777---一种建议的token合同接口标准)
      - [该提案有几个目标，包括:](#该提案有几个目标包括)
    - [ERC721 - 不可替代的Token（契据）标准](#erc721---不可替代的token契据标准)
  - [Token接口标准的扩展](#token接口标准的扩展)
    - [*所有者控制*](#所有者控制)
    - [*燃烧*](#燃烧)
    - [*Minting*](#minting)
